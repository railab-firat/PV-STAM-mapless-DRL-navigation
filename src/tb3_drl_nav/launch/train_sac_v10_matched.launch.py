#!/usr/bin/env python3
"""train_sac_v10_matched.launch.py — Task 8: width-matched Huber rerun.
Identical structure to train_sac_lstm.launch.py, just swaps the agent and
uses the standard SR-gated goal_manager_dynamic (curriculum logic unchanged
from v8/v10 — only the agent's critic width differs)."""
import os
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument("run_id", default_value=f"sac_v10_matched_s{seed}"),
        ...
        TimerAction(period=6.0, actions=[
            ...
            Node(package="tb3_drl_nav", executable="sac_v10_matched",
